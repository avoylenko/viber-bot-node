# Node Viber Bot API
Use this library to develop a bot for the Viber platform. This project forked **[GitHub](https://github.com/Viber/viber-bot-node)**  project since th original project has not been updated for long time.
The library is available on **[GitHub](https://github.com/avoylenko/viber-bot-node)** as well as a package on [npm](https://github.com/avoylenko/node-viber-bot-api).
...
## Installation
This library is released on [npm](https://github.com/avoylenko/node-viber-bot-api).

### npm
Install with [`npm install viber-bot --save`](https://github.com/avoylenko/node-viber-bot-api)
